...
# ─── OPENROUTER VISION (gratis, sem rate limit pratico) ──────────────────────
...
def analyze_image_with_claude(image_bytes):
    if not OPENROUTER_KEY:
        raise Exception("OPENROUTER_KEY nao configurada no Render!")
    ...
    r = requests.post(
        ...
        headers={
            ...
            "HTTP-Referer":   "https://tronforex.onrender.com",
            "X-Title":        "Tron Forex Bot"
        },
        json={
